...
/******************************
2018/12/22 steven :
I'm glad to get your boot log,in which I find the chip IC firmware version is not right.
so please follow the steps as follow:
...
3:please check the updated IC version,and send to me¡£
4:after updating the firmware successfully,please do not configure  macro HYN_UPDATE_FORCE_ONLINE(line:86) later.
********************************/
...
#define    HYN_RESET_PIN  490   //config reset pin
